# Dedicated Git Status & Sync Script for ChittorTech-Certificate-Generator
# Target GitHub Repository: https://github.com/sharmakush2003/ChittorTech-Certificate-Generator.git

$projectName = "ChittorTech-Certificate-Generator"
$targetRemote = "https://github.com/sharmakush2003/ChittorTech-Certificate-Generator.git"
